...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1710397578035.292";
}
var meta = ({
  data
}) => {
...
function Collection() {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "collection", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Sr, { connection: collection.products, children: ({
      nodes,
      isLoading,
      PreviousLink,
      NextLink
...
//# sourceMappingURL=http://localhost:3100/mini-oxygen/00000/11111/22222/33333/build/routes/($locale).collections.$handle-4DWI2AFU.js.map
