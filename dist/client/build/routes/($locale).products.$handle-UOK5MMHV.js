import "http://localhost:3100/mini-oxygen/00000/11111/22222/33333/build/_shared/chunk-5AMZDBXS.js";
import {
  Ie,
  Image,
  Money,
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1710397577680.99";
}
var meta = ({
  data
}) => {
...
function ProductForm({
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "product-form", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(an, { handle: product.handle, options: product.options, variants, children: ({
      option
...
function AddToCartButton({
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Ie, { route: "/cart", inputs: {
    lines
  }, action: Ie.ACTIONS.LinesAdd, children: (fetcher) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(import_jsx_dev_runtime.Fragment, { children: [
...
//# sourceMappingURL=http://localhost:3100/mini-oxygen/00000/11111/22222/33333/build/routes/($locale).products.$handle-UOK5MMHV.js.map
